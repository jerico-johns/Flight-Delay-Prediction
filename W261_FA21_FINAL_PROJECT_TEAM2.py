...
def compareBaselines(model = None, model_name = None, features = None, paramGrid = None, train_data = train_model_small, validation_data = validation_data_small, test_data = False):  
  ...
  if model is None: 
    ...
    f_beta = MulticlassClassificationEvaluator(labelCol='dep_del15', predictionCol='prediction_majority', metricName='fMeasureByLabel', beta = 0.5, metricLabel = 1)
    ...
    f_beta = MulticlassClassificationEvaluator(labelCol='dep_del15', predictionCol='prediction', metricName='fMeasureByLabel', beta = 0.5, metricLabel = 1)
